...
\caption{The current-starved branch barely responds to the oscillations because there is so little current flowing through the circuit.  This gets amplified somewhat in the next branch, and almost fully amplified at the next circuit.}
\label{smallBias}
\end{figure}
